...
function TkAudial(a, b) {
  ...
  if (a.target.getAttribute("class") && -1 != a.target.getAttribute("class").indexOf("tk-audial")) {
  ...
  if (this.startY) {
    this.clientY = a.clientY, a.preventDefault(), a.touches && (a = a.touches[0]);var b = (a.clientY - this.startY) * (a.altKey ? 2 : 1) * (a.shiftKey ? 3 : 1),
        c = this.value + b * this.options.step * -1,
