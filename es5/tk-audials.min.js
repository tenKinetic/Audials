...
function TkAudial(a, b) {
  ...
  if (this.startY) {
    this.clientY = a.clientY, a.preventDefault(), a.touches && (a = a.touches[0]);var b = (a.clientY - this.startY) * (a.altKey ? 2 : 1) * (a.shiftKey ? 3 : 1);this.touchCount > 1 && (b = (a.clientY - this.startY) * this.touchCount + 1), (a.altKey || a.shiftKey || this.touchCount > 1 || this.options.alwaysMultiply) && 1 != this.options.sensitivityMultiplier && (b *= this.options.sensitivityMultiplier);var c = this.value + b * this.options.step * -1,
